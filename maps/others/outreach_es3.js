...
zipcode_boundaries.forEach(item => {
    // zip codes
    if (item.properties.name !== "Nashville") {
        item.dataLabels = {
            enabled: true,
            format: item.properties.name + '<br>' + item.properties.zipcode
        }
    } else {
        item.dataLabels = {
            enabled: true,
            format: item.properties.zipcode
        }
    }
});
    ...
    series: [
        {
            ...
            dataLabels: {
                enabled: true,
                format: '{point.properties.zipcode}',
                style: {
